        ...
        <b-form class="mb-5" @submit.prevent="sendMessage">
          ...
          <b-form-group id="input-group-3" label="Your Message">
            <b-form-textarea
              ...
              no-resize
              rows="3"
              placeholder="Watsup Happiness, are you available for.."
              required
            ></b-form-textarea>
          </b-form-group>
...
export default {
  ...
  methods: {
    async sendMessage(e) {
      ...
      fetch("https://formspree.io/f/xyyvpleb", {
        method: "POST",
        body: data,
        headers: {
  ...
  head: {
    title: "Contact 📧 - Omale Happiness",
    meta: [
      {
        hid: "description",
        name: "description",
        content:
          "Do you have any enquires? Send a message now to Omale Happiness"
      },
      {
        hid: "og:title",
        name: "og:title",
        content: "Contact 📧 - Omale Happiness"
      },
      {
